...
describe('RegisterComponent', () => {
  ...
  fit('Frontend_day36_should_show_username_required_error_message_on_register_page', fakeAsync(() => {
  ...
  fit('Frontend_day36_should_show_password_required_error_message_on_register_page', fakeAsync(() => {
