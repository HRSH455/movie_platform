...
describe('MovieListComponent', () => {
  ...
  fit('Frontend_day31_create_Movie_List_Component_with_movies_array', () => {
    expect(component).toBeTruthy();
    expect((component as any).movies).toBeDefined();
  });

  fit('Frontend_day32_should_have_updateMovie_method', () => {
    expect((component as any).updateMovie).toBeDefined();
    expect(typeof (component as any).updateMovie).toBe('function');
  });

  fit('Frontend_day32_should_have_deleteMovie_method', () => {
